                ...
                <div class="row">
					...
					<div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/operator/proccess_add_student">
                                <div class="card-body">
                                    <h4 class="card-title">Add New Student</h4>
										<div class="row">
											<div class="col-md-6">
												...
												<div class="input-group">
													<input type="text" class="form-control" id="username" name="nisn" placeholder="Username/NISN">
												</div>
